...
const STS = [
    "do 5",
    "define x num as 5",
    "type generator{T} as () -> T",
    "define x num as 5 do 6",
    "do 8 type x as num",
    "define x (num, str) -> num as y",
    "define x (num, num) -> num as (map (num x, num y) -> vec{num}[x, y])(0, {1, 2}.0)[2]",
    "do {1, {\"hello\", 56, true}}.1.1",
    "",
    "do match x + 5 case 3 -> 5 case 1 -> {} default -> 39",
    "define x num as match default -> 50",
    "do vec{str}[].4.56.23[1203.453]()(x, y, z)",
    "do 6 and not -2 + -7 - - 8 or (3 and (6 or 3))",
    "define x{T, R} (T, R) -> T as map (T x, [R] y) -> x",
    "define m{} () -> num as map () -> define g{T, R} num as 6 5",
    "type obj{Q, R} as {Q, (R, Q, obj2{num, T}) -> Q, num}",
    "define m{T} (T) -> T as map (T in) -> in do m{num}(4)"
];
